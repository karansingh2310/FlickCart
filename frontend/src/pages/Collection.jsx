...
const sortProduct = (e)=>{
  ...
  useEffect(()=>{
    applyFilter()
  },[category,price,search,showSearch])
      ...
      <div className="min-w-60 pl-4">
        ...
        <div className={`border border-gray-300 pl-5 py-3 mt-4 ${showFilter ? '' : 'hidden'} sm:block`}>
          ...
          <div className="flex flex-col gap-2 text-sm font-light text-gray-700">
            ...
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'Appliances'} onChange={toggleCategory}/> Appliances
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'Personal Care'} onChange={toggleCategory}/> Personal Care
            </p>
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'Travel'} onChange={toggleCategory}/> Travel
            </p>
            <p className='flex gap-2'>
            ...
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'Footwear'} onChange={toggleCategory}/> Footwear
            </p>
            <p className='flex gap-2'>
